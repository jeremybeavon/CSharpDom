...
{
    public sealed class StructNestedAbstractClassWithMonoCecil :
            ...
            DestructorWithMonoCecil>
    {
        ...
        internal StructNestedAbstractClassWithMonoCecil(ITypeWithMonoCecil declaringType, TypeDefinition type)
        {
