...
namespace CSharpDom.Mono.Cecil.Internal
{
    ...
    {
        public static ClassMemberInheritanceModifier InheritanceModifier(this MethodInfo method, IInternalTypeWithMonoCecil type)
        {
            return method.InheritanceModifier(() => type.HiddenMembersAnalyzer.IsMethodHidden(method));
        }

        public static SealedClassMemberInheritanceModifier SealedClassInheritanceModifier(this MethodInfo method, IInternalTypeWithMonoCecil type)
        {
