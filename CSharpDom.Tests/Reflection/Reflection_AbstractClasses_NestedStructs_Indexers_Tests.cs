...
namespace CSharpDom.Tests.Reflection
{
    ...
    public sealed class Reflection_AbstractClasses_NestedStructs_Indexers_Tests : AbstractSolutionWithReflectionTests
    {
        ...
        [TestMethod]
        public async Task TestAbstractClassWithNestedStructWithIndexerWithWith2AccessorAttributesIn1AttributeGroupUsingReflection()
        {
        ...
        [TestMethod]
        public async Task TestAbstractClassWithNestedStructWithIndexerWithWith2AttributesIn1AttributeGroupUsingReflection()
        {
        ...
        [TestMethod]
        public async Task TestAbstractClassWithNestedStructWithIndexerWith2ParametersWithParametersUsingReflection()
        {
