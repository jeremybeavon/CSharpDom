...
namespace CSharpDom.Tests.Reflection
{
    ...
    public sealed class Reflection_Structs_NestedClasses_Methods_ExplicitInterfaceMethods_Tests : AbstractSolutionWithReflectionTests
    {
        ...
        [TestMethod]
        public async Task TestStructWithNestedClassWithExplicitInterfaceMethodWith2AttributesIn1AttributeGroupUsingReflection()
        {
        ...
        [TestMethod]
        public async Task TestStructWithNestedClassWithExplicitInterfaceWithMethodWithParametersWithAttributesUsingReflection()
        {
