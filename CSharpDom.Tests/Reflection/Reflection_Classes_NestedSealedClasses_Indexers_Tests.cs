...
namespace CSharpDom.Tests.Reflection
{
    ...
    public sealed class Reflection_Classes_NestedSealedClasses_Indexers_Tests : AbstractSolutionWithReflectionTests
    {
        ...
        [TestMethod]
        public async Task TestClassWithNestedSealedClassWithIndexerWithWith2AccessorAttributesIn1AttributeGroupUsingReflection()
        {
        ...
        [TestMethod]
        public async Task TestClassWithNestedSealedClassWithIndexerWithWith2AttributesIn1AttributeGroupUsingReflection()
        {
        ...
        [TestMethod]
        public async Task TestClassWithNestedSealedClassWithIndexerWith2ParametersWithParametersUsingReflection()
        {
