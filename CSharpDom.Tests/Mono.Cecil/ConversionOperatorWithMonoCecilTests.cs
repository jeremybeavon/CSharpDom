...
{
    [TestClass]
    public class ConversionOperatorWithMonoCecilTests : AbstractSolutionTests<ProjectWithMonoCecil>
    {
        ...
        [TestMethod]
        public async Task TestClassWithMonoCecilWithExplicitConversionOperatorAsync()
        {
            await TestClassAsync(typeof(ClassWithExplicitConversionOperator));
        }

        [TestMethod]
        public async Task TestClassWithMonoCecilWithImplicitConversionOperatorConstraintAsync()
        {
