...
namespace CSharpDom.Tests.Mono.Cecil
{
    ...
    public sealed class MonoCecil_SealedClasses_NestedStructs_Indexers_Tests : AbstractSolutionWithMonoCecilTests
    {
        ...
        [TestMethod]
        public async Task TestSealedClassWithNestedStructWithIndexerWithWith2AccessorAttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestSealedClassWithNestedStructWithIndexerWithWith2AttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestSealedClassWithNestedStructWithIndexerWith2ParametersWithParametersUsingMonoCecil()
        {
