...
namespace CSharpDom.Tests.Mono.Cecil
{
    ...
    public sealed class MonoCecil_AbstractClasses_Indexers_Tests : AbstractSolutionWithMonoCecilTests
    {
        ...
        [TestMethod]
        public async Task TestAbstractClassWithIndexerWithWith2AccessorAttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestAbstractClassWithIndexerWithWith2AttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestAbstractClassWithIndexerWith2ParametersWithParametersUsingMonoCecil()
        {
