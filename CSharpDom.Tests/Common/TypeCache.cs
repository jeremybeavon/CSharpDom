...
{
    public sealed class TypeCache : AbstractGenericVisitor
    {
        public TypeCache(ISolution solution)
        {
            AbstractClasses = new Dictionary<string, IAbstractClass>();
            Classes = new Dictionary<string, IClass>();
            SealedClasses = new Dictionary<string, ISealedClass>();
            StaticClasses = new Dictionary<string, IStaticClass>();
            Structs = new Dictionary<string, IStruct>();
            solution.AcceptChildrenAsync(this).Wait();
        }

        public IDictionary<string, IAbstractClass> AbstractClasses { get; private set; }

        public IDictionary<string, IClass> Classes { get; private set; }

        public IDictionary<string, ISealedClass> SealedClasses { get; private set; }

        public IDictionary<string, IStaticClass> StaticClasses { get; private set; }

        public IDictionary<string, IStruct> Structs { get; private set; }
        ...
        {
            AbstractClasses.Add(@class.Name, @class);
        }
        ...
        {
            SealedClasses.Add(@class.Name, @class);
        }
