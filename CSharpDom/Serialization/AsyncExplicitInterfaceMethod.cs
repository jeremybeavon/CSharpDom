...
{
    public sealed class AsyncExplicitInterfaceMethod :
        IAsyncExplicitInterfaceMethod<AttributeGroup, IType, InterfaceReference, GenericParameterDeclaration, TypeReference, MethodParameter, MethodBody>
    {
        public AsyncExplicitInterfaceMethod()
        {
