...
{
    public sealed class ClassNestedSealedClassFactory : AbstractFactory<IClassNestedSealedClass, ClassNestedSealedClass>
    {
        public ClassNestedSealedClassFactory(IClassNestedSealedClass nestedClass)
            : base(nestedClass)
        {
        }
        ...
        {
            Value = new ClassNestedSealedClass()
            {
