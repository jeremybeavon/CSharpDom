...
{
    public sealed class StructNestedAbstractClassFactory : AbstractFactory<IStructNestedAbstractClass, StructNestedAbstractClass>
    {
        public StructNestedAbstractClassFactory(IStructNestedAbstractClass nestedClass)
            : base(nestedClass)
        {
        }
        ...
        {
            Value = new StructNestedAbstractClass()
            {
