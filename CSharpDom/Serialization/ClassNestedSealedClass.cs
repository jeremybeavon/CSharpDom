...
{
    public sealed class ClassNestedSealedClass :
            ...
            StaticConstructor>
    {
        ...
        {
            visitor.VisitClassNestedSealedClass(this);
        }

        public void AcceptChildren(IGenericVisitor visitor)
        {
            GenericVisitor.VisitClassNestedSealedClassChildren(this, visitor);
        }
    }
}
