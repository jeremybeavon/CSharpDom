...
{
    public sealed class AsyncVoidClassMethod :
        IAsyncVoidClassMethod<AttributeGroup, IClassType, GenericParameterDeclaration, MethodParameter, MethodBody>
    {
        public AsyncVoidClassMethod()
        {
