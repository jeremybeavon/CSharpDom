...
{
    public sealed class AsyncSealedClassMethod :
        IAsyncSealedClassMethod<AttributeGroup, ISealedType, GenericParameterDeclaration, TypeReference, MethodParameter, MethodBody>
    {
        public AsyncSealedClassMethod()
        {
