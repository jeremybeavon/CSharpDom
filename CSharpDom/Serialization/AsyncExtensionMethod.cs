...
{
    public sealed class AsyncExtensionMethod :
        IAsyncExtensionMethod<AttributeGroup, IStaticClass, GenericParameterDeclaration, TypeReference, ExtensionParameter, MethodParameter, MethodBody>
    {
        public AsyncExtensionMethod()
        {
