...
{
    internal sealed class ClassNestedSealedClassWrapper : AbstractWrapper<IClassNestedSealedClass>
    {
        public ClassNestedSealedClassWrapper(IClassNestedSealedClass nestedClass)
            : base(nestedClass)
        {
        }
