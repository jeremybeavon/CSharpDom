...
{
    public sealed class StaticClassNestedAbstractClassWithReflection :
            ...
            DestructorWithReflection>
    {
        ...
        internal StaticClassNestedAbstractClassWithReflection(ITypeWithReflection declaringType, Type type)
        {
