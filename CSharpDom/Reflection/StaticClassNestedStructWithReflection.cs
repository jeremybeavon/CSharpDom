...
{
    public sealed class StaticClassNestedStructWithReflection :
            ...
            StaticConstructorWithReflection>
    {
        ...
        internal StaticClassNestedStructWithReflection(ITypeWithReflection declaringType, Type type)
        {
        ...
        {
            get { return nestedStruct.Type.StaticClassMemberVisibility(); }
        }
    }
}
