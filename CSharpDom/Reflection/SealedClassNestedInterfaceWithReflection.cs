...
{
    public sealed class SealedClassNestedInterfaceWithReflection :
        AbstractSealedClassNestedInterface<
            ...
            InterfaceMethodWithReflection>
    {
        ...
        internal SealedClassNestedInterfaceWithReflection(ITypeWithReflection declaringType, Type type)
        {
        ...
        {
            get { return nestedInterface.Type.SealedClassMemberVisibility(); }
        }
    }
}
