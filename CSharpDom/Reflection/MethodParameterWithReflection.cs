...
{
    public sealed class MethodParameterWithReflection :
        AbstractMethodParameter<AttributeWithReflection, ITypeReferenceWithReflection>
    {
        private readonly ParameterWithReflection parameter;

        internal MethodParameterWithReflection(ParameterWithReflection parameter)
        {
