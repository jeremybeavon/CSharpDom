...
{
    public sealed class StructNestedAbstractClassWithReflection :
            ...
            StaticConstructorWithReflection>
    {
        ...
        internal StructNestedAbstractClassWithReflection(ITypeWithReflection declaringType, Type type)
        {
