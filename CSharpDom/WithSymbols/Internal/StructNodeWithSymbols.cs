...
namespace CSharpDom.WithSymbols.Internal
{
    ...
    {
        public StructNodeWithSymbols(StructDeclarationSyntax declaration, ITypeContainer container)
        ...
        IReadOnlyCollection<INestedStructDeclarationWithSymbols> IHasDeclarations<INestedStructDeclarationWithSymbols>.Declarations
        {
            get { return new ReadOnlyNodeCollection<INestedStructDeclarationWithSymbols, StructDeclarationNode>(Declarations); }
        }

        IReadOnlyCollection<IStructDeclarationWithSymbols> IHasDeclarations<IStructDeclarationWithSymbols>.Declarations
        {
            get { return new ReadOnlyNodeCollection<IStructDeclarationWithSymbols, StructDeclarationNode>(Declarations); }
        }
