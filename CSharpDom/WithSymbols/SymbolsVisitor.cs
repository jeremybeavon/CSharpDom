...
namespace CSharpDom.WithSymbols
{
    public abstract class SymbolsVisitor
    {
        ...
        public virtual void VisitClassDeclaration(ClassDeclarationWithSymbols node)
        {
            DefaultVisit(node);
        }
        ...
        public virtual void VisitInterfaceDeclaration(InterfaceDeclarationWithSymbols node)
        {
            DefaultVisit(node);
        }
        ...
        public virtual void VisitNestedClassDeclaration(NestedClassDeclarationWithSymbols node)
        {
            DefaultVisit(node);
        }
        ...
        public virtual void VisitNestedInterfaceDeclaration(NestedInterfaceDeclarationWithSymbols node)
        {
            DefaultVisit(node);
        }
        ...
        public virtual void VisitNestedStructDeclaration(NestedStructDeclarationWithSymbols node)
        {
            DefaultVisit(node);
        }
        ...
        public virtual void VisitStructDeclaration(StructDeclarationWithSymbols node)
        {
            DefaultVisit(node);
        }
