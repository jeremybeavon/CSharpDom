...
{
    public interface IEditableClassType<TAttributeGroup, TGenericParameter, TClassReference, TInterfaceReference, TEventCollection, TPropertyCollection, TIndexerCollection, TMethodCollection, TFieldCollection, TConstructor, TOperatorOverload, TConversionOperator, TNestedClassCollection, TNestedDelegate, TNestedEnum, TNestedInterface, TNestedStructCollection, TStaticConstructor, TDestructor> :
        IEditableClassType,
        ...
        IEditableClassTypeDefinition<TAttributeGroup, TGenericParameter, TClassReference, TInterfaceReference>,
        IHasEditableDestructor<TDestructor>,
