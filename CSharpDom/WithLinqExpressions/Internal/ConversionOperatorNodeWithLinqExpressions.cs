...
{
    internal class ConversionOperatorNodeWithLinqExpressions : ConversionOperatorNodeWithReflection,
        IConversionOperatorWithLinqExpressions
    {
        public ConversionOperatorNodeWithLinqExpressions(
        ...
        public IConversionOperatorWithReflection Reflection
        {
            get { return this; }
        }
