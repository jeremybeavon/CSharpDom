...
{
    public sealed class EnumMemberWithLinqExpressions
    {
        private readonly IEnumMemberWithLinqExpressions enumMember;

        public EnumMemberWithLinqExpressions(IEnumMemberWithLinqExpressions enumMember)
        {
        ...
        public EnumWithLinqExpressions DeclaringType
        {
            get { return new EnumWithLinqExpressions(enumMember.DeclaringType); }
        }
