...
namespace CSharpDom.BaseClasses.Partial
{
    public abstract class AbstractStaticClassNestedStaticPartialClass<
        ...
        TStaticConstructor> :
        AbstractStaticClassNestedStaticClass<TAttributeGroup, TDeclaringType, TGenericParameter, TEventCollection, TPropertyCollection, TMethodCollection, TFieldCollection, TNestedClassCollection, TNestedDelegate, TNestedEnum, TNestedInterface, TNestedStructCollection, TStaticConstructor>,
