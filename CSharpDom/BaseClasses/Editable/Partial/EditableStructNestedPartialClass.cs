...
{
    public abstract class EditableStructNestedPartialClass<
        TAttributeGroup,
        TDeclaringType,
        TGenericParameter,
        TClassReference,
        ...
        where TDestructor : IDestructor
    {
        ...
        {
            visitor.VisitStructNestedPartialClass(this);
        }

        public override void AcceptChildren(IGenericVisitor visitor)
        {
            GenericVisitor.VisitStructNestedPartialClassChildren(this, visitor);
        }
    }
}
