...
{
    public abstract class EditableStructNestedSealedPartialClass<
        TAttributeGroup,
        TDeclaringType,
        TGenericParameter,
        TClassReference,
        ...
        where TDestructor : IDestructor
    {
        ...
        {
            visitor.VisitStructNestedSealedPartialClass(this);
        }

        public override void AcceptChildren(IGenericVisitor visitor)
        {
            GenericVisitor.VisitStructNestedSealedPartialClassChildren(this, visitor);
        }
    }
}
