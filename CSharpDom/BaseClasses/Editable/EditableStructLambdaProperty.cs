...
{
    public abstract class EditableStructLambdaProperty<TAttributeGroup, TDeclaringType, TTypeReference, TExpression> :
        EditableLambdaProperty<TAttributeGroup, TDeclaringType, TTypeReference, TExpression>,
        IEditableStructLambdaProperty<TAttributeGroup, TDeclaringType, TTypeReference, TExpression>
