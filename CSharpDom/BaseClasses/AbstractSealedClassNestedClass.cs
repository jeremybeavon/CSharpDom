...
{
    public abstract class AbstractSealedClassNestedClass<
        TAttributeGroup,
        TDeclaringType,
        TGenericParameter,
        TClassReference,
        ...
        where TStaticConstructor : IStaticConstructor
    {
        ...
        {
            visitor.VisitSealedClassNestedClass(this);
        }

        public override void AcceptChildren(IGenericVisitor visitor)
        {
            GenericVisitor.VisitSealedClassNestedClassChildren(this, visitor);
        }
    }
}
