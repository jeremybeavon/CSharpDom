...
namespace CSharpDom.Editable.Partial
{
    public abstract class EditableClassNestedStaticPartialClass<
        ...
        TStaticConstructor> :
        EditableClassNestedStaticClass<TAttributeGroup, TDeclaringType, TGenericParameter, TEventCollection, TProperty, TMethodCollection, TFieldCollection, TNestedClassCollection, TNestedDelegate, TNestedEnum, TNestedInterface, TNestedStructCollection, TStaticConstructor>,
