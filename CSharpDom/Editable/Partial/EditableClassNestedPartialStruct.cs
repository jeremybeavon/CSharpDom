...
{
    public abstract class EditableClassNestedPartialStruct<
        TAttributeGroup,
        TDeclaringType,
        TGenericParameter,
        TInterfaceReference,
        ...
        where TStaticConstructor : IStaticConstructor
    {
        ...
        {
            visitor.VisitClassNestedPartialStruct(this);
        }

        public override void AcceptChildren(IGenericVisitor visitor)
        {
            GenericVisitor.VisitClassNestedPartialStructChildren(this, visitor);
        }
    }
}
