...
{
    public class SourceCodeBuilder : StatementVisitor
    {
        // Type text
        ...
        public override void Visit(GenericParameter node)
        {
            using (IncrementIndent())
            {
                ...
                else if (node.TypeConstraint != GenericParameterTypeConstraint.None)
                {
                    AppendWithIndent("where " + node.Name + " : ");
                    hasWhere = true;
                    Append(node.TypeConstraint == GenericParameterTypeConstraint.Class ? "class" : "struct");
                }
        ...
        private void AppendCommaSeparatedCollection<T>(Collection<T> collection, string initialCommaText)
        ...
        private void AppendGenericParameters(Collection<GenericParameter> genericParameters)
        {
        ...
        private void AppendGenericParameterConstraints(Collection<GenericParameter> genericParameters)
        {
            genericParameters.AcceptIfNotNull(this);
        }

        private void AppendMethodParameters(Collection<MethodParameter> parameters)
        {
            Append("(");
        ...
        private void AppendMethodParameters(Collection<ClassMethodParameter> parameters)
        {
            Append("(");
            AppendCommaSeparatedCollection(parameters, string.Empty);
            Append(")");
