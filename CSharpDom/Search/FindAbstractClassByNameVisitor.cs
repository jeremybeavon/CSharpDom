...
{
    public sealed class FindAbstractClassByNameVisitor<T> : AbstractTypeSearchVisitor<T>
        where T : IAbstractClass
    {
        public FindAbstractClassByNameVisitor(string name)
        {
            Name = name;
        }
        ...
        {
            VisitChildren(classCollection.AbstractClasses);
        }
