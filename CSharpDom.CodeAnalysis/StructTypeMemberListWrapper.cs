...
{
    internal class StructTypeMemberListWrapper<TChildNode, TChildSyntax> :
        MemberListWrapper<StructTypeWithCodeAnalysis, StructDeclarationSyntax, TChildNode, TChildSyntax>
