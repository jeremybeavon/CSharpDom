...
{
    internal class StructDeclarationNodeWithSyntax : StructDeclarationNode, IStructDeclarationSyntax,
        INestedStructDeclarationSyntax
    {
        public StructDeclarationNodeWithSyntax(StructDeclarationSyntax declaration, ITypeContainer container)
        ...
        INestedStructSyntax IHasCompositeType<INestedStructSyntax>.CompositeType
        {
            get { return (INestedStructSyntax)CompositeType; }
        }

        IStructSyntax IHasCompositeType<IStructSyntax>.CompositeType
        {
            get { return (IStructSyntax)CompositeType; }
        }
        ...
        {
            return IsNestedType ?
                (AbstractSyntaxNode)new NestedStructDeclarationWithSyntax(this) :
                new StructDeclarationWithSyntax(this);
        }
    }
}
