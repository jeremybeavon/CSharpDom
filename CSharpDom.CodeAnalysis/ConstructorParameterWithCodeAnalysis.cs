...
namespace CSharpDom.CodeAnalysis
{
    public sealed class ConstructorParameterWithCodeAnalysis :
        AbstractConstructorParameter<AttributeGroupWithCodeAnalysis, ITypeReferenceWithCodeAnalysis>
    {
        private readonly ParameterWithCodeAnalysis parameter;

        internal ConstructorParameterWithCodeAnalysis(ParameterWithCodeAnalysis parameter)
        {
