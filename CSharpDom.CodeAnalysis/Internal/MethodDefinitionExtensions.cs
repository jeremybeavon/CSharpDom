...
namespace CSharpDom.CodeAnalysis.Internal
{
    ...
    {
        public static ClassMemberInheritanceModifier InheritanceModifier(this MethodDefinition method, IInternalTypeWithCodeAnalysis type)
        {
            return method.InheritanceModifier(() => type.HiddenMembersAnalyzer.IsMethodHidden(method));
        }

        public static SealedClassMemberInheritanceModifier SealedClassInheritanceModifier(this MethodDefinition method, IInternalTypeWithCodeAnalysis type)
        {
