...
{
    internal sealed class AttributeListWrapper<TParent, TParentSyntax> :
        SyntaxNodeList<TParent, TParentSyntax, AttributeGroupWithCodeAnalysis, AttributeListSyntax>
