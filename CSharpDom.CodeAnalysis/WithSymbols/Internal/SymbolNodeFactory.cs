...
namespace CSharpDom.CodeAnalysis.WithSymbols.Internal
{
    internal sealed class SymbolNodeFactory : INodeFactory
    {
        ...
        {
            return new ClassNodeWithSymbols(declaration, container, semanticModel);
        }
        ...
        {
            return new InterfaceNodeWithSymbols(declaration, container, semanticModel);
        }

        public LoadedDocumentNode CreateLoadedDocumentNode(DocumentNode document)
        {
            return new LoadedDocumentNodeWithSymbols(document);
        }

        public LoadedProjectNode CreateLoadedProjectNode(ProjectNode project)
        {
            return new LoadedProjectNodeWithSymbols(project);
        }
        ...
        {
            return new StructNodeWithSymbols(declaration, container, semanticModel);
        }
    }
}
