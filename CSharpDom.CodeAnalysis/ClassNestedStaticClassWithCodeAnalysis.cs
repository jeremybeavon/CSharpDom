...
namespace CSharpDom.CodeAnalysis
{
        ...
        INestedStaticTypeWithCodeAnalysis
    {
        ...
        public ClassNestedStaticClassWithCodeAnalysis(ClassMemberVisibilityModifier visibility, string name)
            : this()
        {
        ...
        {
            get { return DeclaringTypeFunc?.Invoke() ?? classType.Node.GetParentNode<IClassTypeWithCodeAnalysis>(); }
