...
{
    public sealed class AbstractClassNestedPartialStructWithCodeAnalysis :
        ...
        IHasNode<StructDeclarationSyntax>
    {
        ...
        public AbstractClassNestedPartialStructWithCodeAnalysis(
        ...
        {
            get { return DeclaringTypeFunc?.Invoke() ?? structType.Struct.Struct.Node.GetParent<IAbstractTypeWithCodeAnalysis>(); }
