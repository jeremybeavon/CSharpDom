...
{
    public sealed class NestedStaticPartialClassNestedClassWithCodeAnalysis :
        ...
        IClassTypeWithCodeAnalysis
    {
        ...
        public NestedStaticPartialClassNestedClassWithCodeAnalysis(
            ClassMemberVisibilityModifier visibility,
            string name)
            : this(new NestedStaticClassNestedClassWithCodeAnalysis(visibility, name))
        {
        }
        ...
        internal NestedStaticClassNestedClassWithCodeAnalysis InternalClass
        {
