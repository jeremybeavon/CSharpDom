...
{
    public sealed class SealedPartialClassNestedPartialClassWithCodeAnalysis :
        ...
        IPartialClassTypeWithCodeAnalysis
    {
        ...
        {
            get { return classType.Class.InternalClass.InternalClass.Node.GetParentNode<ISealedPartialTypeWithCodeAnalysis>(); }
