...
{
    public sealed class PartialClassNestedPartialStructWithCodeAnalysis :
        ...
        IHasSyntax<StructDeclarationSyntax>
    {
        ...
        public PartialClassNestedPartialStructWithCodeAnalysis(
        ...
        internal PartialClassNestedPartialStructWithCodeAnalysis(ClassNestedPartialStructWithCodeAnalysis @struct)
        {
            structType = @struct;
        ...
        {
            get { return structType.Struct.Struct.Node.GetParentNode<IPartialClassTypeWithCodeAnalysis>(); }
