...
{
    public sealed class AbstractPartialClassNestedAbstractClassWithCodeAnalysis :
        ...
        IAbstractTypeWithCodeAnalysis
    {
        ...
        {
            get { return classType.InternalClass.InternalClass.Type.Node.GetParentNode<IAbstractPartialTypeWithCodeAnalysis>(); }
