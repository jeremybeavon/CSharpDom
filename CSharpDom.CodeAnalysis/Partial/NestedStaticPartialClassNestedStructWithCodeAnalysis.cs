...
{
    public sealed class NestedStaticPartialClassNestedStructWithCodeAnalysis :
        ...
        IStructTypeWithCodeAnalysis
    {
        ...
        public NestedStaticPartialClassNestedStructWithCodeAnalysis(
            ClassMemberVisibilityModifier visibility,
            string name)
            : this(new NestedStaticClassNestedStructWithCodeAnalysis(visibility, name))
        {
        }
        ...
        {
            get { return structType.Struct.Node.GetParentNode<INestedStaticPartialTypeWithCodeAnalysis>(); }
