...
{
    public sealed class SealedClassNestedStaticPartialClassWithCodeAnalysis :
        ...
        INestedStaticPartialTypeWithCodeAnalysis
    {
        ...
        {
            classType = @class ?? new ClassNestedStaticPartialClassWithCodeAnalysis();
        }
        ...
        {
            get { return classType.Class.InternalClass.Class.Node.GetParentNode<ISealedTypeWithCodeAnalysis>(); }
