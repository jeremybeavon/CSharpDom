...
{
    internal sealed class InternalStaticPartialClassMethodCollectionWithCodeAnalysis<TStaticClass> :
        ...
        where TStaticClass : class, IHasSyntax<ClassDeclarationSyntax>
    {
        ...
        internal InternalStaticPartialClassMethodCollectionWithCodeAnalysis(
