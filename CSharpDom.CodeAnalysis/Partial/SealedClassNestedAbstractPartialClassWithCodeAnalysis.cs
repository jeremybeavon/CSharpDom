...
{
    public sealed class SealedClassNestedAbstractPartialClassWithCodeAnalysis :
        ...
        IAbstractPartialTypeWithCodeAnalysis
    {
        ...
        {
            get { return classType.Class.InternalClass.InternalClass.Type.Node.GetParentNode<ISealedTypeWithCodeAnalysis>(); }
