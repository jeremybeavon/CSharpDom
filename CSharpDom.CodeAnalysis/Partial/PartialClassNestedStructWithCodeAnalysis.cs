...
{
    public sealed class PartialClassNestedStructWithCodeAnalysis :
        ...
        IStructTypeWithCodeAnalysis
    {
        ...
        {
            get { return structType.InternalStruct.InternalStruct.Node.GetParentNode<IPartialClassTypeWithCodeAnalysis>(); }
