...
{
    public sealed class PartialClassNestedSealedClassWithCodeAnalysis :
        ...
        ISealedTypeWithCodeAnalysis
    {
        ...
        public PartialClassNestedSealedClassWithCodeAnalysis(
        ...
        internal PartialClassNestedSealedClassWithCodeAnalysis(ClassNestedSealedClassWithCodeAnalysis @class)
        {
            classType = @class;
        ...
        {
            get { return classType.Class.Node.GetParentNode<IPartialClassTypeWithCodeAnalysis>(); }
