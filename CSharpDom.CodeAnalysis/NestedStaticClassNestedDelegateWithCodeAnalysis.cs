...
{
    public sealed class NestedStaticClassNestedDelegateWithCodeAnalysis :
        ...
        IHasNode<DelegateDeclarationSyntax>
    {
        ...
        public NestedStaticClassNestedDelegateWithCodeAnalysis(
        ...
        internal NestedStaticClassNestedDelegateWithCodeAnalysis()
        {
        ...
        {
            get { return DeclaringTypeFunc?.Invoke() ?? nestedDelegate.Delegate.Node.GetParentNode<INestedStaticTypeWithCodeAnalysis>(); }
