...
namespace CSharpDom.Tests.Mono.Cecil
{
    ...
    public sealed class MonoCecil_StaticClasses_NestedClasses_Indexers_Tests : AbstractSolutionWithMonoCecilTests
    {
        ...
        [TestMethod]
        public async Task TestStaticClassWithNestedClassWithIndexerWithWith2AccessorAttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestStaticClassWithNestedClassWithIndexerWithWith2AttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestStaticClassWithNestedClassWithIndexerWith2ParametersWithParametersUsingMonoCecil()
        {
