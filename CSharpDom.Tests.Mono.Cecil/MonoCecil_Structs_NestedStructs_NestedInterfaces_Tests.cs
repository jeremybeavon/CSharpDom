...
namespace CSharpDom.Tests.Mono.Cecil
{
    ...
    public sealed class MonoCecil_Structs_NestedStructs_NestedInterfaces_Tests : AbstractSolutionWithMonoCecilTests
    {
        ...
        [TestMethod]
        public async Task TestStructWithNestedStructWithNestedInterfaceWith2AttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestStructWithNestedStructWithNestedInternalInterfaceUsingMonoCecil()
        {
            await TestStructAsync(typeof(StructWithNestedStructWithNestedInternalInterface));
        }

        [TestMethod]
        public async Task TestStructWithNestedStructWithNestedPrivateInterfaceUsingMonoCecil()
        {
