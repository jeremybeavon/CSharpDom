...
namespace CSharpDom.Tests.Mono.Cecil
{
    ...
    public sealed class MonoCecil_StaticClasses_Methods_Tests : AbstractSolutionWithMonoCecilTests
    {
        ...
        [TestMethod]
        public async Task TestStaticClassWithMethodWith2AttributesIn1AttributeGroupUsingMonoCecil()
        {
        ...
        [TestMethod]
        public async Task TestStaticClassWithMethodWith2ReturnAttributesIn1AttributeGroupUsingMonoCecil()
        {
